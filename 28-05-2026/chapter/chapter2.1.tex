...
Hàm phân biệt thực nghiệm thỏa phương trình
\begin{equation}
	\bm{b}_{\text{opt}}^T
	\left(
	\bm{x}_{\text{bnd}}
...
Ma trận hiệp phương sai mẫu của lớp thứ nhất là
\[
\hat{\Sigma}_1
=
\begin{pmatrix}
...
Ma trận hiệp phương sai mẫu của lớp thứ hai là
\[
\hat{\Sigma}_2
=
\begin{pmatrix}
...
0{,}830 \quad (83{,}0\%).
\]
Độ chính xác của thủ tục phân loại (hay Recall), đối với lớp $C_1$ là
\[
P(\hat{C}_1\mid C_1)
=
\frac{n_{11}}{n_{\bullet 1}}
=
\frac{412}{500}
=
0{,}824
...
Độ chính xác của thủ tục phân loại, đối với lớp $C_2$ là
\[
P(\hat{C}_2\mid C_2)
=
\frac{n_{22}}{n_{\bullet 2}}
=
\frac{418}{500}
=
0{,}836
...
Độ chính xác tiên đoán (hay Precision), đối với lớp $C_1$ là
\[
P(C_1\mid \hat{C}_1)
=
\frac{n_{11}}{n_{1\bullet}}
=
\frac{412}{494}
\approx
0{,}8340
...
Độ chính xác tiên đoán đối với lớp $C_2$ là
\[
P(C_2\mid \hat{C}_2)
=
\frac{n_{22}}{n_{2\bullet}}
=
\frac{418}{506}
\approx
0{,}8261
...
Từ dữ liệu mô phỏng, ta tính trung bình mẫu \(\hat{\bm{\mu}}_1, \hat{\bm{\mu}}_2\) và ma trận hiệp phương sai mẫu của từng lớp. \[ \hat{\pi}_1=\hat{\pi}_2=0{,}5, \] \[ \hat{\bm{\mu}}_1 = \begin{pmatrix} 2{,}9716\\ 3{,}0225 \end{pmatrix}, \qquad \hat{\bm{\mu}}_2 = \begin{pmatrix} 3{,}2101\\ 2{,}5101 \end{pmatrix}, \] Ma trận hiệp phương sai mẫu của lớp 1 là \[ \hat{\Sigma}_1 = \begin{pmatrix} 2{,}1251 & 0{,}9023\\ 0{,}9023 & 1{,}9656 \end{pmatrix}. \] Ma trận hiệp phương sai mẫu của lớp 2 là \[ \hat{\Sigma}_2 = \begin{pmatrix} 1{,}7762 & 0{,}8397\\ 0{,}8397 & 1{,}9534 \end{pmatrix}. \] Từ đó, ma trận hiệp phương sai mẫu gộp được ước lượng bởi \[ \hat{\Sigma} = \begin{pmatrix} 1{,}9507 & 0{,}8710\\ 0{,}8710 & 1{,}9595 \end{pmatrix}. \]
...
\]
Độ chính xác của thủ tục phân loại (hay Recall), đối với lớp $C_1$ là \[ P(\hat{C}_1\mid C_1) = \frac{n_{11}}{n_{\bullet 1}} = \frac{305}{500} = 0{,}610 \quad (61{,}0\%). \] Độ chính xác của thủ tục phân loại, đối với lớp $C_2$ là \[ P(\hat{C}_2\mid C_2) = \frac{n_{22}}{n_{\bullet 2}} = \frac{300}{500} = 0{,}600 \quad (60{,}0\%). \] Độ chính xác tiên đoán (Precision), đối với lớp $C_1$ là \[ P(C_1\mid \hat{C}_1) = \frac{n_{11}}{n_{1\bullet}} = \frac{305}{505} \approx 0{,}6040 \quad (60{,}40\%). \] Độ chính xác tiên đoán, đối với lớp $C_2$ là \[ P(C_2\mid \hat{C}_2) = \frac{n_{22}}{n_{2\bullet}} = \frac{300}{495} \approx 0{,}6061 \quad (60{,}61\%). \] Từ ma trận lỗi theo tần số, ta tính được các tỷ lệ tương ứng bằng công thức \[ p_{ij} = \frac{n_{ij}}{n}, \qquad i,j=1,2. \] Với $n=1000$, ta có \[ p_{11} = \frac{305}{1000} = 0{,}305, \qquad p_{12} = \frac{200}{1000} = 0{,}200, \] \[ p_{21} = \frac{195}{1000} = 0{,}195, \qquad p_{22} = \frac{300}{1000} = 0{,}300. \] Ngoài ra, \[ p_{1\bullet} = p_{11}+p_{12} = 0{,}305+0{,}200 = 0{,}505, \] \[ p_{2\bullet} = p_{21}+p_{22} = 0{,}195+0{,}300 = 0{,}495. \] Mặt khác, \[ p_{\bullet 1} = p_{11}+p_{21} = 0{,}305+0{,}195 = 0{,}500, \] \[ p_{\bullet 2} = p_{12}+p_{22} = 0{,}200+0{,}300 = 0{,}500. \]
...
\begin{table}[H]
	...
	\begin{tabular}{|c|cc|c|}
		...
		Tổng cộng & $0{,}500$ & $0{,}500$  & $1{,}000$ \\ \hline
	\end{tabular}
	\caption{Ma trận lỗi theo tỷ lệ của mô hình LDA trong trường hợp hai lớp chồng lấn nhiều.}
...
\end{pmatrix}.
\]
Ma trận hiệp phương sai mẫu ước lượng của lớp $1$ là \[ \hat{\Sigma}_1 = \begin{pmatrix} 2{,}2861 & 0{,}0921\\ 0{,}0921 & 1{,}9651 \end{pmatrix}. \] Ma trận hiệp phương sai mẫu ước lượng của lớp $2$ là \[ \hat{\Sigma}_2 = \begin{pmatrix} 2{,}0503 & -0{,}1023\\ -0{,}1023 & 1{,}8030 \end{pmatrix}. \] Từ hai ma trận hiệp phương sai mẫu trên, ta thu được ma trận hiệp phương sai mẫu gộp \[ \hat{\Sigma} = \begin{pmatrix} 2{,}1682 & -0{,}0051\\ -0{,}0051 & 1{,}8841 \end{pmatrix}. \]
