...
\begin{frame}{Biên quyết định Bayes hai lớp}
	...
	Nếu \(\pi_1=\pi_2\), thì \(\log\dfrac{\pi_1}{\pi_2}=0\).
...
\begin{frame}{Mô phỏng hai chiều: Hai lớp tách biệt hoàn toàn}
	...
	Vì \(\Sigma=2I\), hai lớp có cùng phương sai theo hai hướng và không tương quan.
	Do đó, biên LDA lý thuyết là đường trung trực của đoạn nối hai tâm:
	\[
	\frac{\bm{\mu}_1+\bm{\mu}_2}{2}
	=
	\begin{pmatrix}
	...
	Vì hai tâm chỉ khác nhau theo trục \(x_1\), biên lý thuyết là
	\[
	x_1=8.
	\]
