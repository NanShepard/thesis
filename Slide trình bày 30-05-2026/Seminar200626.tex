...
%================= SLIDE 17 =================
\begin{frame}{Phương trình biên quyết định}
	\small
	\setlength{\abovedisplayskip}{2pt}
	\setlength{\belowdisplayskip}{2pt}
	
	Từ phương trình (20), xét các điểm \(\bsx_{\text{bnd}}\) nằm trên đường biên
	\[
	\bsx_{\text{bnd}}^T\widehat{\Sigma}^{-1}(\widehat{\bm{\mu}}_1-\widehat{\bm{\mu}}_2)
	- \frac{1}{2} \left( \widehat{\bm{\mu}}_1^T\widehat{\Sigma}^{-1}\widehat{\bm{\mu}}_1 - \widehat{\bm{\mu}}_2^T\widehat{\Sigma}^{-1}\widehat{\bm{\mu}}_2 \right) = 0.
	\]
	
	Do \(\widehat{\Sigma}^{-1}\) là ma trận đối xứng, ta có
	\[
	\widehat{\bm{\mu}}_1^T\widehat{\Sigma}^{-1}\widehat{\bm{\mu}}_1 - \widehat{\bm{\mu}}_2^T\widehat{\Sigma}^{-1}\widehat{\bm{\mu}}_2
	=
	(\widehat{\bm{\mu}}_1 + \widehat{\bm{\mu}}_2)^T \widehat{\Sigma}^{-1} (\widehat{\bm{\mu}}_1 - \widehat{\bm{\mu}}_2).
	\]
	
	Thay vào phương trình trên và nhóm nhân tử chung, ta được
	\[
	\left( \bm{x}_{\text{bnd}} - \frac{\widehat{\bm{\mu}}_1 + \widehat{\bm{\mu}}_2}{2} \right)^T \widehat{\Sigma}^{-1} (\widehat{\bm{\mu}}_1 - \widehat{\bm{\mu}}_2) = 0.
	\]
	
	\vspace{-1.5mm} % Ép khoảng cách thừa
	\begin{block}{Biên phân loại theo \(\bm{b}_{\text{opt}}\)}
		\[
		\bm{b}_{\text{opt}}^T \left( \bsx_{\text{bnd}} - \frac{\widehat{\bm{\mu}}_1 + \widehat{\bm{\mu}}_2}{2} \right) = 0.
		\]
	\end{block}
\end{frame}
